...
//update display mem recebe endereço bse e offset vertical e horizontal
void updateDisplayMem(int matrix[NLIN_MEM][NCOL_MEM], int sv, int sh){
//Passa valor da matriz painel para a matriz de coversao
  ...
  for(int i=0 ;i<NLIN;i++){    
    ...
    for(int j=0;j<NCOL;j++){
      // endereço com offset
        arrayTx[convTable[i][j]>>8][convTable[i][j]&0xff] = matrix[i+sv][j+sh];
